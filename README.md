...
Hello, World! 👋 <br><br> I am Damian, a developer and machine learning engineer with a theoretical physics background, with keen interest in building web/mobile apps, machine learning and IoT. I greatly enjoy working on my own personal web/mobile app development projects, data science, and meddle in hardware too! I am also an ex-physics lecturer and computing trainer who enjoys teaching and <a href="https://medium.com/@bohmian/">writing articles</a> to share my projects with everyone. 
